...
@OpenAPIDefinition(servers = {
        @Server(url = "/v1/jobpost/", description = "To Gateway Endpoint"),
        @Server(url = "http://localhost:${server.port}", description = "Direct JobPost URL")
})
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("Company Job Post Services API")
                        .contact(new Contact()
