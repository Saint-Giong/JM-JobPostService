...
import rmit.saintgiong.jobpost.domain.services.JobPostDeleteService;
...
class JobPostDeleteServiceTest {
    ...
    void givenNonExistentId_whenDelete_thenDomainExceptionPropagates() {
        // Arrange
        when(baseValidator.assertExistsById(existingId)).thenThrow(new DomainException(DomainCode.RESOURCE_NOT_FOUND, "Not found"));
